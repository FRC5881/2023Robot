...
class ArmSubsytemTest {
    ...
    void testArmKinematics() {
        System.out.println("testArmKinematics");
    ...
    @Test
    void testArmKinematicsAligned() {
        System.out.println("testArmKinematicsAligned");

        Rotation2d stage1Angle =
                Rotation2d.fromDegrees(Math.random() * Constants.Arm.LIMIT_DEGREE_STAGE_1);
    ...
    void fuzzArmKinematics() {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            Rotation2d stage2Angle =
                    Rotation2d.fromDegrees(Math.random() * Constants.Arm.LIMIT_DEGREE_STAGE_2);
            Rotation2d stage3Angle =
                    Rotation2d.fromDegrees(Math.random() * Constants.Arm.LIMIT_DEGREE_STAGE_3);
