...
public final class Constants {
    ...
    public static final class Swerve {
         ...
         * revolutions.
         * 
         * This is 1 / (gear ratio)
         */
        public static final double DRIVE_REDUCTION_FACTOR = (16.0 / 48.0) * (28.0 / 16.0) * (15.0 / 60.0);

        /**
         * The reduction factor from turn encoder motor revolutions to turning wheel
         * revolutions.
         * 
         * This is 1 / (gear ratio)
         */
         ...
         */
        public static final double DRIVE_CONVERSION_FACTOR = (WHEEL_DIAMETER * Math.PI) / DRIVE_REDUCTION_FACTOR;
