...
public class ArmSubsystem extends SubsystemBase {
    ...
    private final CANSparkMax stage1 = new CANSparkMax(Constants.CANConstants.ARM_STAGE_ONE, CANSparkMaxLowLevel.MotorType.kBrushless);
    private final CANSparkMax stage2 = new CANSparkMax(Constants.CANConstants.ARM_STAGE_TWO, CANSparkMaxLowLevel.MotorType.kBrushless);
    private final CANSparkMax stage3 = new CANSparkMax(Constants.CANConstants.ARM_STAGE_THREE, CANSparkMaxLowLevel.MotorType.kBrushless);
    ...
    public ArmSubsystem() {
        ...
        stage1.setSoftLimit();
        stage1.getPIDController().setOutputRange(0, stage1.getSoftLimit());
        ...
        stage2.setSoftLimit();
        stage2.getPIDController().setOutputRange(0, stage2.getSoftLimit());
        ...
        stage3.setSoftLimit();
        stage3.getPIDController().setOutputRange(0, stage3.getSoftLimit());
    }
    ...
    public InstantCommand cUpdatePID() {
        runOnce(() -> {
